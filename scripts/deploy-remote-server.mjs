...
const vidbeeInternalBaseUrl = "http://vidbee-api:3100";
...
const envValues = {
  ...
  OMNIAGENT_MEDIA_PROVIDER: fromSource("OMNIAGENT_MEDIA_PROVIDER", "vidbee"),
  OMNIAGENT_MEDIA_PROVIDER_FALLBACK_ENABLED: fromSource(
    "OMNIAGENT_MEDIA_PROVIDER_FALLBACK_ENABLED",
    "true",
  ),
  OMNIAGENT_MEDIA_PROVIDER_LEGACY_PLATFORMS: fromSource(
    "OMNIAGENT_MEDIA_PROVIDER_LEGACY_PLATFORMS",
  ),
  OMNIAGENT_MEDIA_PROVIDER_VIDBEE_PLATFORMS: fromSource(
    "OMNIAGENT_MEDIA_PROVIDER_VIDBEE_PLATFORMS",
  ),
  OMNIAGENT_MEDIA_PROVIDER_VIDEO_INFO: fromSource(
    "OMNIAGENT_MEDIA_PROVIDER_VIDEO_INFO",
  ),
  OMNIAGENT_MEDIA_PROVIDER_VIDEO_INFO_LEGACY_PLATFORMS: fromSource(
    "OMNIAGENT_MEDIA_PROVIDER_VIDEO_INFO_LEGACY_PLATFORMS",
  ),
  OMNIAGENT_MEDIA_PROVIDER_VIDEO_INFO_VIDBEE_PLATFORMS: fromSource(
    "OMNIAGENT_MEDIA_PROVIDER_VIDEO_INFO_VIDBEE_PLATFORMS",
  ),
  OMNIAGENT_MEDIA_PROVIDER_DOWNLOAD_VIDEO: fromSource(
    "OMNIAGENT_MEDIA_PROVIDER_DOWNLOAD_VIDEO",
  ),
  OMNIAGENT_MEDIA_PROVIDER_DOWNLOAD_VIDEO_LEGACY_PLATFORMS: fromSource(
    "OMNIAGENT_MEDIA_PROVIDER_DOWNLOAD_VIDEO_LEGACY_PLATFORMS",
  ),
  OMNIAGENT_MEDIA_PROVIDER_DOWNLOAD_VIDEO_VIDBEE_PLATFORMS: fromSource(
    "OMNIAGENT_MEDIA_PROVIDER_DOWNLOAD_VIDEO_VIDBEE_PLATFORMS",
  ),
  OMNIAGENT_MEDIA_PROVIDER_DOWNLOAD_AUDIO: fromSource(
    "OMNIAGENT_MEDIA_PROVIDER_DOWNLOAD_AUDIO",
  ),
  OMNIAGENT_MEDIA_PROVIDER_DOWNLOAD_AUDIO_LEGACY_PLATFORMS: fromSource(
    "OMNIAGENT_MEDIA_PROVIDER_DOWNLOAD_AUDIO_LEGACY_PLATFORMS",
  ),
  OMNIAGENT_MEDIA_PROVIDER_DOWNLOAD_AUDIO_VIDBEE_PLATFORMS: fromSource(
    "OMNIAGENT_MEDIA_PROVIDER_DOWNLOAD_AUDIO_VIDBEE_PLATFORMS",
  ),
  OMNIAGENT_VIDBEE_BASE_URL: fromSource(
    "OMNIAGENT_VIDBEE_BASE_URL",
    vidbeeInternalBaseUrl,
  ),
  OMNIAGENT_VIDBEE_API_KEY: fromSource("OMNIAGENT_VIDBEE_API_KEY"),
  OMNIAGENT_VIDBEE_DOWNLOAD_DIR: fromSource(
    "OMNIAGENT_VIDBEE_DOWNLOAD_DIR",
    "/vidbee-downloads",
  ),
  OMNIAGENT_VIDBEE_REQUEST_TIMEOUT_MS: fromSource(
    "OMNIAGENT_VIDBEE_REQUEST_TIMEOUT_MS",
    "60000",
  ),
  OMNIAGENT_VIDBEE_POLL_INTERVAL_MS: fromSource(
    "OMNIAGENT_VIDBEE_POLL_INTERVAL_MS",
    "1000",
  ),
  OMNIAGENT_VIDBEE_MAX_WAIT_MS: fromSource(
    "OMNIAGENT_VIDBEE_MAX_WAIT_MS",
    "180000",
  ),
  OMNIAGENT_VIDBEE_PROXY: fromSource("OMNIAGENT_VIDBEE_PROXY"),
  VIDBEE_CONFIG_PATH: fromSource("VIDBEE_CONFIG_PATH"),
  VIDBEE_COOKIES_PATH: fromSource("VIDBEE_COOKIES_PATH"),
  VIDBEE_BROWSER_FOR_COOKIES: fromSource("VIDBEE_BROWSER_FOR_COOKIES"),
  VIDBEE_EMBED_SUBS: fromSource("VIDBEE_EMBED_SUBS"),
  VIDBEE_EMBED_THUMBNAIL: fromSource("VIDBEE_EMBED_THUMBNAIL"),
  VIDBEE_EMBED_METADATA: fromSource("VIDBEE_EMBED_METADATA"),
  VIDBEE_EMBED_CHAPTERS: fromSource("VIDBEE_EMBED_CHAPTERS"),
